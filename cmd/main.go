...
import (
	...
	"github.com/stolostron/cluster-curator-rollout-controller/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "ff72c5cc.open-cluster-management.io",
	...
	if err = (&controller.ClusterCuratorRolloutReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ClusterCuratorRollout")
		os.Exit(1)
	}
