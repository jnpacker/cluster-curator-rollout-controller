...
var (
	...
	projectImage = "example.com/cluster-curator-rollout-controller:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting cluster-curator-rollout-controller integration test suite\n")
